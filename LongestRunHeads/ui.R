    ...
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        sliderInput("trials",
                    ...
                    min = 10, max = 400, value = 100, step=10),br(),
        ...
        checkboxInput("checkbox2", label = "Show quantifying bias plot", value = FALSE),
        
        
        checkboxInput("showProp", label = "Modify probability of heads", FALSE),
        numericInput("iterations",
                     label = h5("Number of repetitions to generate P(H|H):"),
                     value = 1, min = 1, max = 100, step = 1), br(),
      ...
      mainPanel(
        ...
        plotOutput("phhPlot", width = "100%"), HTML("<hr style='height: 2px; color: #de7008;
                                                   background-color: #df7109; border: none;'>"),
        
        plotOutput("phhPlot2", width = "100%"), HTML("<hr style='height: 2px; color: #de7008;
                                                   background-color: #df7109; border: none;'>"),
        # 
        # plotOutput("streakPlot", width = "100%"), HTML("<hr style='height: 2px; color: #de7008;
        #                                            background-color: #df7109; border: none;'>"),
